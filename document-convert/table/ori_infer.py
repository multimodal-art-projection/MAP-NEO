...
if __name__ == "__main__":
    args = utility.parse_table_args()
    args.table_model_dir = r'models/en_ppstructure_mobile_v2.0_SLANet_infer'
    args.table_char_dict_path = r'models/en_ppstructure_mobile_v2.0_SLANet_infer/table_structure_dict.txt'
    args.det_model_dir
    args.rec_model_dir
